...
#   HARBOR_FQDN      Harbor registry hostname (e.g., <your-harbor>)
...
#   e.g., node-labeler-v0.2.0-amd64.tar.gz -> <your-harbor>/library/node-labeler:v0.2.0
set -euo pipefail
...
# <your-harbor> /library/ is configured. The idempotency check below
